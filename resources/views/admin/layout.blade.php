...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="{{ route('admin') }}" class="logo">Posts <span class="lite">Admin</span></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="active">
            <a class="" href="{{ url('admin/dashboard/all-clients') }}">
              <i class="icon_profile"></i>
              <span>Clients</span>
            </a>
          </li>
          <li class="active">
            <a class="" href="{{ url('admin/dashboard/subscribers') }}">
...
<script src="{{ asset('tinymce/editors.js') }}"></script>
<script>
  tinymce.init({
       selector: 'textarea'
     });
